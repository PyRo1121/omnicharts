...
export async function ingestHelixStream(env: Env, stream: HelixStream, minViewers: number): Promise<SampleArchiveRow | undefined> {
...
export async function flushSampleArchivePage(env: Env, rows: SampleArchiveRow[]): Promise<void> {
